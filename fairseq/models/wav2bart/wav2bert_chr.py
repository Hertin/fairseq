...
@register_model("wav2bert_chr", dataclass=Wav2BertConfig)
class Wav2BertChr(BaseFairseqModel):
    def __init__(self, cfg: Wav2BertConfig, w2v_encoder: BaseFairseqModel, task: FairseqTask):
        super().__init__()
        self.cfg = cfg
    ...
    @classmethod
    def build_model(cls, cfg: Wav2BertConfig, task: FairseqTask):
...
class Wav2VecEncoder(FairseqEncoder):
    def __init__(self, cfg: Wav2BertConfig, tgt_dict=None):
