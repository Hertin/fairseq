...
@dataclass
class Wav2BartPoolConfig(FairseqDataclass):
    w2v_path: str = field(
...
@register_model("wav2bartpool", dataclass=Wav2BartPoolConfig)
class Wav2BartPool(FairseqEncoderDecoderModel):
    def __init__(self, encoder, decoder):
        super().__init__(encoder, decoder)

    @classmethod
    def build_model(cls, cfg: Wav2BartPoolConfig, task: FairseqTask):
        ...
        model = Wav2BartPool(encoder, decoder)
        return model

    @classmethod
    def build_encoder(cls, cfg: Wav2BartPoolConfig):
    ...
    @classmethod
    def build_decoder(cls, cfg: Wav2BartPoolConfig):
