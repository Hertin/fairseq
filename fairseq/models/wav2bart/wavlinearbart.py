...
@dataclass
class WavLinearBartConfig(FairseqDataclass):
    w2v_path: str = field(
...
@register_model("wavlinearbart", dataclass=WavLinearBartConfig)
class WavLinearBart(FairseqEncoderDecoderModel):
    def __init__(self, encoder, decoder):
        super().__init__(encoder, decoder)

    @classmethod
    def build_model(cls, cfg: WavLinearBartConfig, task: FairseqTask):
        ...
        model = WavLinearBart(encoder, decoder)
        return model

    @classmethod
    def build_encoder(cls, cfg: WavLinearBartConfig):
        encoder = Wav2VecEncoder(cfg)
        return encoder

    @classmethod
    def build_decoder(cls, cfg: WavLinearBartConfig):
...
class Wav2VecEncoder(FairseqEncoder):
    def __init__(self, cfg: WavLinearBartConfig, tgt_dict=None):
